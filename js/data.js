...
const GAME_DATA = {
    ...
    PLAYER: {
        ...
        ATTACK_BASE: 5,
        DEFENSE_BASE: 0,
        HUNGER_DECAY: 1,          // 每次衰減量
        HUNGER_INTERVAL: 15000,   // 飢餓衰減間隔(ms)
        HUNGER_DAMAGE: 2,         // 飢餓時扣血量
        STAMINA_REGEN: 0.5,
        INV_SIZE: 20
    },
    ...
    ITEMS: {
        ...
        fruit:    { name: '野果', type: 'food', stack: 20, desc: '飢餓+8', hunger: 8 },
        leather:  { name: '皮革', type: 'resource', stack: 99, desc: '恐龍皮革' },
        bone:     { name: '骨頭', type: 'resource', stack: 50, desc: '恐龍骨骼' },
        meat:     { name: '生肉', type: 'resource', stack: 20, desc: '未烹飪的肉' },
        cooked_meat: { name: '烤肉', type: 'food', stack: 10, desc: '飢餓+25 HP+5', hunger: 25, hp: 5 },
        stew:     { name: '燉湯', type: 'food', stack: 5, desc: '飢餓+50 HP+15', hunger: 50, hp: 15 },
        antidote: { name: '解毒藥', type: 'food', stack: 10, desc: '解除中毒', cleanse: true },
        heal_pot: { name: '治療藥水', type: 'food', stack: 5, desc: 'HP+40', hp: 40 },
